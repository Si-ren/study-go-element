...
// protoc -I . --go_out ./gen/go  --go_opt paths=source_relative ./student.proto
type Student struct {
...
func (x *Student) GetHeight() int64 {
	if x != nil {
		return x.Height
	}
	return 0
...
func (x *FindStudent) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*FindStudent) ProtoMessage() {}

func (x *FindStudent) ProtoReflect() protoreflect.Message {
	mi := &file_student_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use FindStudent.ProtoReflect.Descriptor instead.
func (*FindStudent) Descriptor() ([]byte, []int) {
	return file_student_proto_rawDescGZIP(), []int{1}
}

func (x *FindStudent) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
var file_student_proto_rawDesc = []byte{
	...
	0x06, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x73, 0x22, 0x47, 0x0a, 0x07, 0x53, 0x74, 0x75, 0x64, 0x65,
	...
	,
}
...
var file_student_proto_goTypes = []interface{}{
	...
	(*FindStudent)(nil), // 1: models.FindStudent
}
var file_student_proto_depIdxs = []int32{
	1, // 0: models.GetStudentInfo.GetStudentInfo:input_type -> models.FindStudent
	0, // 1: models.GetStudentInfo.GetStudentInfo:output_type -> models.Student
