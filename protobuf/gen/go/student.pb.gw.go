...
// RegisterGetStudentInfoHandlerServer registers the http handlers for service GetStudentInfo to "mux".
...
func RegisterGetStudentInfoHandlerServer(ctx context.Context, mux *runtime.ServeMux, server GetStudentInfoServer) error {
	...
	mux.Handle("GET", pattern_GetStudentInfo_GetStudentInfo_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/models.GetStudentInfo/GetStudentInfo", runtime.WithHTTPPathPattern("/student/{name}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_GetStudentInfo_GetStudentInfo_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		...
		forward_GetStudentInfo_GetStudentInfo_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
// RegisterGetStudentInfoHandlerFromEndpoint is same as RegisterGetStudentInfoHandler but
// automatically dials to "endpoint" and closes the connection when "ctx" gets done.
func RegisterGetStudentInfoHandlerFromEndpoint(ctx context.Context, mux *runtime.ServeMux, endpoint string, opts []grpc.DialOption) (err error) {
	...
	return RegisterGetStudentInfoHandler(ctx, mux, conn)
}
...
// to "mux". The handlers forward requests to the grpc endpoint over the given implementation of "extProtobuf.GetStudentInfoClient".
...
func RegisterGetStudentInfoHandlerClient(ctx context.Context, mux *runtime.ServeMux, client GetStudentInfoClient) error {
	...
	mux.Handle("GET", pattern_GetStudentInfo_GetStudentInfo_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/models.GetStudentInfo/GetStudentInfo", runtime.WithHTTPPathPattern("/student/{name}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_GetStudentInfo_GetStudentInfo_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_GetStudentInfo_GetStudentInfo_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1}, []string{"student", "name"}, ""))
)

var (
	forward_GetStudentInfo_GetStudentInfo_0 = runtime.ForwardResponseMessage
)
